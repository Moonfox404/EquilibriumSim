...
public class Simulation {
    ...
    // no default
    public Simulation(Particle[] system){
        this.system = system;
    }
    // no copy
    ...
    private static void updateStatus(Particle[] system){
    ...
    private static void testSim(Particle[] system){
        System.out.println();
    ...
    private static void elasticCollision(Particle p1, Particle p2){
